...
function NavigationContent() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-none">
        <div className="container mx-auto px-4 py-3 flex items-center justify-center relative border-b-0">
          <Link href="/" className="text-xl font-bold neon-text font-mono text-center border-b-0">
            BLXK STUDIO
          </Link>
