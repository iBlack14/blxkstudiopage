...
function FounderHeroComponent() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-background flex items-center md:py-12 lg:py-20 border-0 border-none" style={{ paddingTop: 0, paddingBottom: 'var(--space-8)' }}>
