...
export function resolveLocaleWithMeta(input: {
  ...
  const fromHeader = input.acceptLanguage
    ...
    : undefined
  const fromAcceptLanguage = fromHeader && isLocale(fromHeader) ? fromHeader : undefined
...
export const messages: Record<Locale, Messages> = {
  es: {
    ...
    hero: {
      badge: "Soluciones Tecnológicas Empresariales",
      ...
      descriptionSecondary: "Ejecución técnica sólida, enfoque en resultados.",
      stackTitle: "Stack Tecnológico",
      ctaProjects: "Explorar Proyectos",
      ctaConsultation: "Solicitar Consulta",
      agencyLabel: "Agencia Tecnológica",
